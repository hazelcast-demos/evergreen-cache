...
public class UpdateCacheJob {
    ...
    private StreamSource<ChangeRecord> cdc(Map<String, String> env) {
    ...
    private Sink<Map.Entry<Long, Person>> cache(Map<String, String> env) {
    ...
    private Pipeline pipeline() {
        ...
        var source = cdc(env);
        FunctionEx<ChangeRecord, Person> toPerson = record -> record.value().toObject(Person.class);
